...
if (!isset($_POST['project recieval']) || empty($_POST['project recieval'])) {
    header("Location: client_dashboard.php");
    exit();
}

$project_Id = $_POST['project recieval'];
...
$query = "SELECT * FROM uploaded_projects WHERE project_Id = '$project_Id'";
