<!-- <?php
    ...
    <script src =  "js/jquery.js"></script>
        ...
        <img src="SkillMatch_logo.png" alt="Skill Match logo" height="100px" width="100px" style="display: inline-block;">
        <h2 style="color:green; font-size:3rem; font-family: Verdana,sans-serif; display: inline-block;"><b>SkillMatch</b></h2>
    </div>
    ...
    <div class="topnav">
      ...
      <a class="active" href="home.php">Hompage</a> 
      <a href="../login/login_client.php">Client Login</a>
